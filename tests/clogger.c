...
int main(int argc, char** argv)
{
    ...
    if (pn_proactor_addr(addr_buffer, 128, hostname, port) >= 128) {
        fprintf(stderr, "Error: host address string too long\n");
        exit(1);
    }
    ...
    pn_proactor_connect2(proactor, pn_conn, 0, addr_buffer);
